...
!define MUI_ICON "aseprite-1.3.2-win\build\bin\data\icons\ase.ico"
!define MUI_UNICON "aseprite-1.3.2-win\build\bin\data\icons\ase.ico"

; 欢迎页面
!insertmacro MUI_PAGE_WELCOME
; 许可协议页面
!insertmacro MUI_PAGE_LICENSE "aseprite-1.3.2-win\build\bin\data\EULA.txt"
; 安装目录选择页面
...
Section "MainSection" SEC01
  ...
  File /r "aseprite-1.3.2-win\build\bin\*.*"
  File /r "aseprite-1.3.2-win\libcrypto-1_1-x64.dll"
  ...
  File "aseprite-1.3.2-win\build\bin\aseprite.exe"
SectionEnd
